...
# Bot Admins
ADMINS = environ.get('ADMINS', '1391556668 5162208212')
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001822021062 -1001589399161').split()]
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/TG_Karthik")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Star_Bots_Tamil')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/Star_Moviess_Tamil')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Star_Bots_Tamil")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/Star_Bots_Tamil")

# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 3600)) # Add time in seconds
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
MAX_BTN = int(environ.get('MAX_BTN', 10))
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'tam tamil eng english hindi telugu kannada malayalam').split()]
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001821439025")
